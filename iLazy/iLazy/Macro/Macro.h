...
#define iS_ORDER_ADDRESS @"http://139.129.16.185:8080/iLazy/index.php/Home/Order/query"
//#define iS_ORDER_ADDRESS @"http://10.110.6.26:5555/iLazy/index.php/Home/Order/query"

#pragma mark - c_order表查询
#define iS_ORDER_ALL_ADDRESS @"http://139.129.16.185:8080/iCrazy/index.php/Home/Order/queryAll"
//#define iS_ORDER_ALL_ADDRESS @"http://10.110.6.26:5555/iCrazy/index.php/Home/Order/queryAll"

#pragma mark - c_userInfo表查询
#define iS_SElECT_USERINFO @"http://139.129.16.185:8080/iCrazy/index.php/Home/UserInfo/query"
...
#define iS_ALTER_ORDER_INFO @"http://139.129.16.185:8080/iLazy/index.php/Home/Order/updateOreder"
...
#define iS_INSERT_COMMENT @"http://139.129.16.185:8080/iLazy/index.php/Home/Comment/insert"
//#define iS_INSERT_COMMENT @"http://10.110.6.26:5555/iLazy/index.php/Home/Comment/insert"

#pragma mark - 添加反馈信息
#define iS_INSERT_IDEA @"http://139.129.16.185:8080/iLazy/index.php/Home/Repeat/idea"
//#define iS_INSERT_IDEA @"http://10.110.6.26:5555/iLazy/index.php/Home/Repeat/idea"

#pragma mark - 添加反馈图片
#define iS_INSERT_IDEA_IMAGE @"http://139.129.16.185:8080/iLazy/index.php/Home/Repeat/uploadIderImage"
//#define iS_INSERT_IDEA_IMAGE @"http://10.110.6.26:5555/iLazy/index.php/Home/Repeat/uploadIderImage"

#pragma mark - 添加头像
#define iS_INSERT_USER_IMAGE @"http://139.129.16.185:8080/iLazy/index.php/Home/UserInfo/uploadHeaderImage"
//#define iS_INSERT_USER_IMAGE @"http://10.110.6.26:5555/iLazy/index.php/Home/UserInfo/uploadHeaderImage"

#pragma mark - 图片路径
#define IMAGE_PATH @"http://139.129.16.185:8080/iLazy/Home/image/images/"
#define CRAZY_IMAGE_PATH @"http://139.129.16.185:8080/iCrazy/Home/image/images/"
...
#pragma mark - 检验密码
#define iS_TEST_PASSWORD @"http://139.129.16.185:8080/iLazy/index.php/Home/User/queryName"
...
#define iS_SELECTALL_CREDIT @"http://139.129.16.185:8080/iCrazy/index.php/Home/Credit/queryAll"
//#define iS_SELECTALL_CREDIT @"http://10.110.6.26:5555/iCrazy/index.php/Home/Credit/queryAll"

#pragma mark - 修改用户信息表
#define iS_INSERT_USER_CREDIT @"http://139.129.16.185:8080/iCrazy/index.php/Home/Credit/updata"
//#define iS_INSERT_USER_CREDIT @"http://10.110.6.26:5555/iCrazy/index.php/Home/Credit/updata"

//-------------------XDD-------------------------

#define iS_LOGIN_ADDRESS @"http://139.129.16.185:8080/iLazy/index.php/Home/User/login"
//#define iS_LOGIN_ADDRESS @"http://10.110.6.26:5555/iLazy/index.php/Home/User/login"

#pragma mark - 用户注册信息
#define iS_REGISTER_ADDRESS @"http://139.129.16.185:8080/iLazy/index.php/Home/User/signin"
//#define iS_REGISTER_ADDRESS @"http://10.110.6.26:5555/iLazy/index.php/Home/User/signin"

#pragma mark ----查看用户是否已经注册过
#define iS_ExistName @"http://139.129.16.185:8080/iLazy/index.php/Home/Repeat/query"
//#define iS_ExistName @"http://10.110.6.26:5555/iLazy/index.php/Home/Repeat/query"

#pragma mark-------请求插入订单
#define iS_Insert_Order @"http://139.129.16.185:8080/iLazy/index.php/Home/Order/insert"
//#define iS_Insert_Order @"http://10.110.6.26:5555/iLazy/index.php/Home/Order/insert"

#pragma mark ---请求用户信息表
#define iS_Insert_UserInfo @"http://139.129.16.185:8080/iLazy/index.php/Home/UserInfo/insert"
//#define iS_Insert_UserInfo @"http://10.110.6.26:5555/iLazy/index.php/Home/UserInfo/insert"

#pragma mark ---请求找回密码请求
#define iS_Uppassword @"http://139.129.16.185:8080/iLazy/index.php/Home/User/uppassword"
...
#define iS_DELETE_ORDER @"http://139.129.16.185:8080/iLazy/index.php/Home/Order/delet"
...
//插入存储Lazy端的用户位置信息
#define iS_INSERT_ILAZY_LOCATION @"http://139.129.16.185:8080/iLazy/index.php/Home/Location/insert"
//#define iS_INSERT_ILAZY_LOCATION @"http://10.110.6.26:5555/iLazy/index.php/Home/Location/insert"

//修改存储Lazy端的用户位置信息
#define INSERT_ILAZY_LOCATION @"http://139.129.16.185:8080/iLazy/index.php/Home/Location/update"
//#define iS_INSERT_ILAZY_LOCATION @"http://10.110.6.26:5555/iLazy/index.php/Home/Location/insert"

//修改Lazy端的用户信息
#define iS_ALTER_ILAZY_USERINFO @"http://139.129.16.185:8080/iLazy/index.php/Home/UserInfo/updata"
//#define iS_ALTER_ILAZY_USERINFO @"http://10.110.6.26:5555/iLazy/index.php/Home/UserInfo/updata"

//修改Lazy端的用户密码
#define iS_ALTER_ILAZY_PASSWORD @"http://139.129.16.185:8080/iLazy/index.php/Home/User/uppassword"
...
//查询Crazy端的用户位置信息
#define iS_SElECT_ICRAZY_USERLOCATION @"http://139.129.16.185:8080/iCrazy/index.php/Home/Location/query"
...
//修改Lazy端的用户密码
#define iS_ALTER_ILAZY_USERPASSWD @"http://139.129.16.185:8080/iLazy/index.php/Home/User/uppassword"
