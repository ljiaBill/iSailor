...
- (void)interfaceDesign
{
    ...
    name1.textColor = COLORNAVIGATION;
    ...
    name1Line.backgroundColor = COLORNAVIGATION;
    ...
    name2.textColor = COLORNAVIGATION;
    ...
    name2Line.backgroundColor = COLORNAVIGATION;
    ...
    name3.textColor = COLORNAVIGATION;
    ...
    name3Line.backgroundColor = COLORNAVIGATION;
