...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //
        UIView *line1 = [[UIView alloc] initWithFrame:CGRectMake(UISCREEN_WIDTH/3, 0, kLineWidth, 216)];
        line1.backgroundColor = color;
        [self addSubview:line1];
        
        UIView *line2 = [[UIView alloc] initWithFrame:CGRectMake(UISCREEN_WIDTH*2/3-1, 0, kLineWidth, 216)];
        line2.backgroundColor = color;
        [self addSubview:line2];
        
        for (int i=0; i<3; i++)
        {
            UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 54*(i+1), UISCREEN_WIDTH, kLineWidth)];
...
-(UIButton *)creatButtonWithX:(NSInteger) x Y:(NSInteger) y
{
    ...
    switch (y)
    {
        case 0:
            frameX = 0.0;
            frameW = UISCREEN_WIDTH/3;
            break;
        case 1:
            frameX = UISCREEN_WIDTH/3-1;
            frameW = UISCREEN_WIDTH/3;
            break;
        case 2:
            frameX = UISCREEN_WIDTH*2/3;
            frameW = UISCREEN_WIDTH/3;
    ...
    {
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 6, frameW, 28)];
        label.text = @".";
        label.textColor = [UIColor blackColor];
    ...
    {
        UIImageView *arrow = [[UIImageView alloc] initWithFrame:CGRectMake(46, 19, 22, 17)];
...
-(void)clickButton:(UIButton *)sender
{
    ...
    {
        NSString *point =@".";
        [self.delegate numberKeyboardInput:point];
        return ;
    }
