                        ...
                        if (self.passwordtext.text.length >=6) {
                            ...
                            [request registUser:dic and:^(NSDictionary *dataDic) {
                                ...
                                [request insertUserInfo:mdic and:^(NSDictionary *dataDic) {
                                    ...
                                    //将勤人端注册的userid发送给 地图主页 ，接受c_userid
                                    [mapView setValue:[self.userdic objectForKey:@"userid"] forKey:@"c_userid"];
                                ...
                                NSMutableDictionary *crditdic = [[NSMutableDictionary alloc]init];
                                [crditdic setValue:useridd forKey:@"userid"];
                                [crditdic setValue:@"0" forKey:@"creditinfo"];
                                
                                [request insertcredit:crditdic and:^(NSDictionary *dataCreditDic) {
                                    
                                    NSString *crditstr = [dataCreditDic objectForKey:@"code"];
                                    
                                    if ([crditstr isEqualToString:@"succeed"]) {
