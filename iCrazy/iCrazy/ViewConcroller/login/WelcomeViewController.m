...
- (void)viewDidLoad {
    ...
    imageview.image = [UIImage imageNamed:@"crazy.jpg"];
...
-(void)loginbtn{
    ...
    self.loginBtn = [[UIButton alloc]initWithFrame:CGRectMake(UISCREEN_WIDTH*0.53, UISCREEN_HEIGHT*0.87, UISCREEN_WIDTH*0.4, 30)];
...
-(void)registerbtn{
    ...
    self.registerBtn = [[UIButton alloc]initWithFrame:CGRectMake(UISCREEN_WIDTH*0.075, UISCREEN_HEIGHT*0.87, UISCREEN_WIDTH*0.4, 30)];
    
    [self.registerBtn setTitle:@"注册" forState:UIControlStateNormal];
    
    self.registerBtn.titleLabel.font = [UIFont systemFontOfSize:15];
    
    self.registerBtn.backgroundColor = COLORMAMP(146,204,212,1);
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [userlogin getInfo:^(NSMutableDictionary *dic) {
        ...
        else
        {
            ...
            [map  setValue:self.userid forKey:@"c_userid"];
