...
- (void)layoutSubviews
{
    ...
    //按钮
    _butView.frame = CGRectMake(_showView.bounds.size.width/2-self.bounds.size.width/4+_showLable.bounds.size.width, 0, _showView.bounds.size.width-(_showView.bounds.size.width/2-self.bounds.size.width/4)-_showLable.bounds.size.width-10, self.bounds.size.height-5);
