...
#define iS_ORDER_ALL_ADDRESS @"http://139.129.16.185:8080/iLazy/index.php/Home/Order/queryAll"
//#define iS_ORDER_ALL_ADDRESS @"http://10.110.6.26:5555/iLazy/index.php/Home/Order/queryAll"

#pragma mark - c_order表查询
#define iS_ORDER_ADDRESS @"http://139.129.16.185:8080/iCrazy/index.php/Home/Order/query"
//#define iS_ORDER_ADDRESS @"http://10.110.6.26:5555/iCrazy/index.php/Home/Order/query"

#pragma mark - l_userInfo表查询
#define iS_SElECT_USERINFO @"http://139.129.16.185:8080/iLazy/index.php/Home/UserInfo/query"
//#define iS_SElECT_USERINFO @"http://10.110.6.26:5555/iLazy/index.php/Home/UserInfo/query"


#pragma mark - 修改l_order状态
#define iS_ALTER_ORDER_STATUS @"http://139.129.16.185:8080/iLazy/index.php/Home/Order/update"
//#define iS_ALTER_ORDER_STATUS @"http://10.110.6.26:5555/iLazy/index.php/Home/Order/update"

#pragma mark - 修改c_order状态
#define iS_ALTER_CRAZY_ORDER_STATUS @"http://139.129.16.185:8080/iCrazy/index.php/Home/Order/update"
...
#define iS_DELETE_LAZY_ORDER @"http://139.129.16.185:8080/iLazy/index.php/Home/Order/delet"
//#define iS_DELETE_LAZY_ORDER @"http://10.110.6.26:5555/iLazy/index.php/Home/Order/delet"

#pragma mark - 删除订单表(c_order)中的信息
#define iS_DELETE_CRAZY_ORDER @"http://139.129.16.185:8080/iCrazy/index.php/Home/Order/delet"
//#define iS_DELETE_CRAZY_ORDER @"http://10.110.6.26:5555/iCrazy/index.php/Home/Order/delet"

#pragma mark - 添加反馈信息
#define iS_INSERT_IDEA @"http://139.129.16.185:8080/iCrazy/index.php/Home/Repeat/idea"
//#define iS_INSERT_IDEA @"http://10.110.6.26:5555/iCrazy/index.php/Home/Repeat/idea"

#pragma mark - 添加反馈图片
#define iS_INSERT_IDEA_IMAGE @"http://139.129.16.185:8080/iCrazy/index.php/Home/Repeat/uploadIderImage"
...
#pragma mark----用户登录
#define iS_LOGIN_ADDRESS @"http://139.129.16.185:8080/iCrazy/index.php/Home/User/login"
//#define iS_LOGIN_ADDRESS @"http://10.110.6.26:5555/iCrazy/index.php/Home/User/login"

#pragma mark - 用户注册信息
#define iS_REGISTER_ADDRESS @"http://139.129.16.185:8080/iCrazy/index.php/Home/User/signin"
//#define iS_REGISTER_ADDRESS @"http://10.110.6.26:5555/iCrazy/index.php/Home/User/signin"

#pragma mark ----查看用户是否已经注册过
#define iS_ExistName @"http://139.129.16.185:8080/iCrazy/index.php/Home/Repeat/query"
//#define iS_ExistName @"http://10.110.6.26:5555/iCrazy/index.php/Home/Repeat/query"

#pragma mark ---请求插入用户信息表
#define iS_Insert_UserInfo @"http://139.129.16.185:8080/iCrazy/index.php/Home/UserInfo/insert"
//#define iS_Insert_UserInfo @"http://10.110.6.26:5555/iCrazy/index.php/Home/UserInfo/insert"

#pragma mark-------请求查询（懒人端）所有订单(模糊订单)
#define iS_Order_Search @"http://139.129.16.185:8080/iLazy/index.php/Home/Order/search"
//#define iS_Order_Search @"http://10.110.6.26:5555/iLazy/index.php/Home/Order/search"

#pragma mark ---请求找回密码请求
#define iS_Uppassword @"http://139.129.16.185:8080/iCrazy/index.php/Home/User/uppassword"
//#define iS_Uppassword @"http://10.110.6.26:5555/iCrazy/index.php/Home/User/uppassword"

#pragma  mark----------请求用户信息表(懒人端)
#define iS_User_Info @"http://139.129.16.185:8080/iLazy/index.php/Home/UserInfo/query"
//#define iS_User_Info @"http://10.110.6.26:5555/iLazy/index.php/Home/UserInfo/query"

#pragma mark -----------请求插入勤人端订单表
#define iS_Insert_order @"http://139.129.16.185:8080/iCrazy/index.php/Home/Order/insert"
//#define iS_Insert_order @"http://10.110.6.26:5555/iCrazy/index.php/Home/Order/insert"

#pragma mark - 插入用户信用表信息
#define iS_INSERT_CREDIT @"http://139.129.16.185:8080/iCrazy/index.php/Home/Credit/insert"

#pragma mark - 根据orderid查询订单
#define iS_Orderid_order @"http://139.129.16.185:8080/iLazy/index.php/Home/Order/queryOrderid"
//#define iS_Orderid_order @"http://10.110.6.26:5555/iLazy/index.php/Home/Order/queryOrderid"

//------------------------------------------------------------


#define iS_RESET_ADDRESS @"http://139.129.16.185:8080/iLazy/index.php/Home/User/uppassword"
//#define iS_RESET_ADDRESS @"http://10.110.6.26:5555/iLazy/index.php/Home/User/uppassword"

#define iS_USER_STATUS_ADDRESS @"http://139.129.16.185:8080/iLazy/index.php/Home/User/upstatus"
//#define iS_USER_STATUS_ADDRESS @"http://10.110.6.26:5555/iLazy/index.php/Home/User/upstatus"

#define iS_INSERT_COMMENT @"http://139.129.16.185:8080/iCrazy/index.php/Home/Comment/insert"
//#define iS_INSERT_COMMENT @"http://10.110.6.26:5555/iCrazy/index.php/Home/Comment/insert"

#pragma mark - 图片路径(勤人)
#define IMAGE_PATH @"http://139.129.16.185:8080/iCrazy/Home/image/images/"
#define LAZY_IMAGE_PATH @"http://139.129.16.185:8080/iLazy/Home/image/images/"
...
#pragma mark - 添加头像
#define iS_INSERT_USER_IMAGE @"http://139.129.16.185:8080/iCrazy/index.php/Home/UserInfo/uploadHeaderImage"
//#define iS_INSERT_USER_IMAGE @"http://10.110.6.26:5555/iCrazy/index.php/Home/UserInfo/uploadHeaderImage"

#pragma mark - 检验密码
#define iS_TEST_PASSWORD @"http://139.129.16.185:8080/iCrazy/index.php/Home/User/queryName"
...
//插入存储Crazy端的用户位置信息
#define iS_INSERT_ICRAZY_LOCATION @"http://139.129.16.185:8080/iCrazy/index.php/Home/Location/insert"
//#define iS_INSERT_ICRAZY_LOCATION @"http://10.110.6.26:5555/iCrazy/index.php/Home/Location/insert"

//修改Lazy端的用户信息
#define iS_ALTER_ICRAZY_USERINFO @"http://139.129.16.185:8080/iCrazy/index.php/Home/UserInfo/updata"
//#define iS_ALTER_ICRAZY_USERINFO @"http://10.110.6.26:5555/iCrazy/index.php/Home/UserInfo/updata"

//查询Lrazy端的用户信息
#define iS_SElECT_ILAZY_USERINFO @"http://139.129.16.185:8080/iLazy/index.php/Home/UserInfo/query"
//#define iS_SElECT_ILAZY_USERINFO @"http://10.110.6.26:5555/iLazy/index.php/Home/UserInfo/query"

//查询Crazy端的用户信息
#define iS_SElECT_ICRAZY_USERINFO @"http://139.129.16.185:8080/iCrazy/index.php/Home/UserInfo/query"
//#define iS_SElECT_ICRAZY_USERINFO @"http://10.110.6.26:5555/iCrazy/index.php/Home/UserInfo/query"

//修改存储Lazy端的用户位置信息
#define INSERT_ILAZY_LOCATION @"http://139.129.16.185:8080/iCrazy/index.php/Home/Location/update"
//#define iS_INSERT_ILAZY_LOCATION @"http://10.110.6.26:5555/iLazy/index.php/Home/Location/insert"

//查询Lazy端的用户位置
#define iS_SElECT_ILAZY_USERLOCATION @"http://139.129.16.185:8080/iLazy/index.php/Home/Location/query"
//#define iS_SElECT_ILAZY_USERLOCATION @"http://10.110.6.26:5555/iLazy/index.php/Home/Location/query"

//修改Crazy端的用户位置
#define iS_ALTER_ICRAZY_USERLOCATION @"http://139.129.16.185:8080/iCrazy/index.php/Home/Location/update"
//#define iS_ALTER_ICRAZY_USERLOCATION @"http://10.110.6.26:5555/iCrazy/index.php/Home/Location/update"

//修改Lazy端的用户密码
#define iS_ALTER_ICRAZY_USERPASSWD @"http://139.129.16.185:8080/iCrazy/index.php/Home/User/uppassword"
//#define iS_ALTER_ICRAZY_USERPASSWD @"http://10.110.6.26:5555/iCrazy/index.php/Home/User/uppassword"

//修改身份认证状态
#define iS_ALTER_ILAZY_IDCAR_STATUS @"http://139.129.16.185:8080/iCrazy/index.php/Home/UserInfo/approve"
...
//查询状态为2的订单（即未被接的订单）
#define IS_SELECT_ILAZY_ORDERTWO @"http://139.129.16.185:8080/iLazy/index.php/Home/Order/queryStatus"
...
#define iS_SELECT_CREDIT @"http://139.129.16.185:8080/iCrazy/index.php/Home/Credit/query"
